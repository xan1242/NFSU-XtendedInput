...
char* ConvertXInputBitmaskToName(uint16_t in)
{
	switch (in)
	{
...
char* __stdcall ConvertBitmaskToControlString_XBOX(uint16_t in)
{
	switch (in)
	{
	case XINPUT_GAMEPAD_DPAD_UP:
...
char* __stdcall ConvertBitmaskToControlString_PS(uint16_t in)
{
	switch (in)
	{
	case XINPUT_GAMEPAD_DPAD_UP:
...
char* __stdcall ConvertBitmaskToControlString(int mode, uint16_t in)
{
	switch (mode)
	{
	case 1:
